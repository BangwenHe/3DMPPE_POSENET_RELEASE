...
from posenet3d.main.config import cfg
from posenet3d.main.model import get_pose_net
from posenet3d.data.dataset import generate_patch_image
from posenet3d.common.utils.pose_utils import process_bbox, pixel2cam
from posenet3d.common.utils.vis import vis_keypoints, vis_3d_multiple_skeleton
...
for n in range(person_num):
    ...
    cv2.imwrite(f"{n}.jpg", cv2.cvtColor(img, cv2.COLOR_RGB2BGR))
